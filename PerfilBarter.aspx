            ...
            <div class="Perfil">
                <div class="PerfilFoto">
                    ...
                    <asp:Button runat="server" CssClass="Botones" ID="Mostrar" Text="Mostrar Información" OnClick="Mostrar_Click"/>
                        ...
                        <br />
                        <br />
                        Para hacer valida la eliminación se debera realizar dentro del rango de tiempo estipulado dentro del <a href="AvisoPriv.html">Aviso de Privacidad de Barter.</a></small>
                    </div>
                </div>
            </div>
        </div>
